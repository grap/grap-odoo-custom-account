This module extends the functionality of french Accounting module to
make easy the creation of taxes and accounts for GRAP.
...
- Set `digit_codes` (No. of Digits to use for account code) to 3.
  (instead of 6)
