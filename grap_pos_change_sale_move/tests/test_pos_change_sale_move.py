...
class TestChangeSaleMove(TransactionCase):
    def setUp(self):
        ...
        self.tax_code_5 = self.env.ref("grap_pos_change_sale_move.tax_code_5")
                ...
                "lines": [
                    [
                        ...
                        False,
                        {
                            ...
                            and [[6, False, product.taxes_id.ids]]
                            or False,
                            "qty": qty,
                        },
                    ]
    ...
    def _get_sale_moves(self, session):
        if session:
            ...
            return self.move_obj.search(
                [("journal_id", "=", self.sale_journal.id)], order="date"
            )
    ...
    def test_01_move_per_day(self):
        ...
        # sale #2 date 2
        self._sale(session, False, self.product_no_vat, 20, date_diff=1)
